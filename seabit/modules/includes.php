<link rel="stylesheet" href="<?php echo TEMPLATE_URL; ?>css/font.css">
        ...
        <link href="<?php echo TEMPLATE_URL; ?>css/style.css" media="screen" rel="stylesheet" type="text/css" />
        <link href="<?php echo TEMPLATE_URL; ?>css/custom.css" media="screen" rel="stylesheet" type="text/css" />
        
        <link href="<?php echo TEMPLATE_URL; ?>css/easy-autocomplete.css" media="screen" rel="stylesheet" type="text/css" />
        
        
        <link href="<?php echo TEMPLATE_URL; ?>css/theme-color.css" media="screen" rel="stylesheet" type="text/css" />

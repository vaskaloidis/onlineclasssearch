<link rel="stylesheet" href="<?php echo TEMPLATE_URL; ?>css/font.css">
        ...
        <link href="<?php echo TEMPLATE_URL; ?>frontend/css/style.css" media="screen" rel="stylesheet" type="text/css" />
		<link href="<?php echo TEMPLATE_URL; ?>frontend/css/custom.css" media="screen" rel="stylesheet" type="text/css" />
        <link href="<?php echo TEMPLATE_URL; ?>frontend/css/theme-color.css" media="screen" rel="stylesheet" type="text/css" />
        <link href="<?php echo TEMPLATE_URL; ?>css/chosen.css" media="screen" rel="stylesheet" type="text/css" />


		<link href="<?php echo TEMPLATE_URL; ?>frontend/css/bootstrap.css" media="screen" rel="stylesheet" type="text/css" />
		<link href="<?php echo TEMPLATE_URL; ?>frontend/css/responsivemobilemenu.css" media="screen" rel="stylesheet" type="text/css" />
		<link href="<?php echo TEMPLATE_URL; ?>frontend/css/home.css" media="screen" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript" src="<?php echo TEMPLATE_URL; ?>js/responsivemobilemenu.js" ></script>
		<script type="text/javascript" src="<?php echo TEMPLATE_URL; ?>js/smoothslides.min.js" ></script>

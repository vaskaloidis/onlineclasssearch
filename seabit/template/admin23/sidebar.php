...
<div class="collapse navbar-collapse navbar-ex1-collapse">
	<ul class="nav navbar-nav side-nav">
		...
		<li class="active">
			<a href="<?php echo base_url(); ?>admin/page/"><i class="fa fa-fw fa-file-text-o"></i> Pages</a>
		</li>
		<li class="active">
			<a href="<?php echo base_url(); ?>admin/users/"><i class="fa fa-fw fa-users"></i> Users</a>
		</li>
		<li class="active">
			<a href="<?php echo base_url(); ?>admin/ypusa/"><i class="fa fa-fw fa-flickr"></i>Listing</a>
		</li>
		<li>

<link rel="stylesheet" href="<?php echo TEMPLATE_URL; ?>css/font.css">
        ...
        <link href="<?php echo TEMPLATE_URL; ?>frontend/css/easy-autocomplete.css" media="screen" rel="stylesheet" type="text/css" />
        ...
        <script type="text/javascript" src="<?php echo TEMPLATE_URL; ?>js/timer.jquery.js" ></script>
         <script type="text/javascript" src="<?php echo TEMPLATE_URL; ?>js/jquery.easy-autocomplete.js" ></script>
